...
const WithdrawItemBinary = ({ depositHistory }) => {
  ...
  useEffect(() => {
    let config = {
      method: "get",
      url: `${API_ENDPOINT}management/get-wallet-withdraw/${localStorage.getItem("walletAddress")}/2`,
      headers: {
...
export default WithdrawItemBinary;
