...
const SwapItemBinary = ({ swapHistory }) => {
  ...
  useEffect(() => {
    ...
    Axios.request(config)
      .then((response) => {
        setBalance(response.data.balances[3].balance);
    ...
    <div className={`investment-container`}>
      ...
      >
        <div className="flex-1 flex flex-col">
          <h2 className={styles.heading2}>Swap Binary Commission to USDT BEP20</h2>
